#ifndef __BSP_AD7192_H__
#define __BSP_AD7192_H__
...
#define AD7192_CS_PORT                GPIOA
#define AD7192_SCK_PIN                GPIO_PIN_5
#define AD7192_SCK_PORT               GPIOA
#define AD7192_MISO_PIN               GPIO_PIN_6
#define AD7192_MISO_PORT              GPIOA
#define AD7192_MOSI_PIN               GPIO_PIN_7
#define AD7192_MOSI_PORT              GPIOA


#define AD7192_SCLK_H                 HAL_GPIO_WritePin(AD7192_SCK_PORT,AD7192_SCK_PIN,GPIO_PIN_SET)
#define AD7192_SCLK_L                 HAL_GPIO_WritePin(AD7192_SCK_PORT,AD7192_SCK_PIN,GPIO_PIN_RESET)


#define AD7192_CS_ENABLE()            HAL_GPIO_WritePin(AD7192_CS_PORT,AD7192_CS_PIN,GPIO_PIN_RESET)
#define AD7192_CS_DISABLE()           HAL_GPIO_WritePin(AD7192_CS_PORT,AD7192_CS_PIN,GPIO_PIN_SET)
