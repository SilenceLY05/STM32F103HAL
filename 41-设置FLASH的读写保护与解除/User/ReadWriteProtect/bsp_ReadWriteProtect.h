...
#define ADDR_FLAHS_PAGE_0     ((uint32_t)0x08000000) /* Base @ of Page 0, 1 Kbytes */
...
#define FLASH_USER_START_ADDR             ADDR_FLASH_PAGE_32
#define FLASH_USER_END_ADDR               ADDR_FLASH_PAGE_48
...
#if defined(WRITE_PROTECTION_ENABLE)&&defined(WRITE_PROTECTION_DISABLE)
#define "Switches WRITE PROTECTION ENABLE & WRITE PROTECTION DISABLE cannot be enabled in the time!"
#endif 
...
#endif /* __BSP_READWRITEPROTECT_H__ */
