...
/* 设置光照模式 mode：光照模式 0-5 0：自动 1：晴天 2：多云 3：办公室 4：家里 5：夜晚 */
...
/* 设置特殊效果 eff:特殊效果，参数范围[0~6] 0:正常 1:黑白 2:偏蓝 3:复古 4:偏红 5:偏绿 6:反相 */
...
void OV7725_Window_Set(uint16_t sx,uint16_t sy,uint16_t width,uint16_t height,uint8_t QVGA_VGA)
{
	...
	/***************VSTART*********************/
	/* 读取寄存器内容，VStart包含偏移值，在原始偏移值的基础上加上窗口偏移 */
